import os
import sys
sys.path.insert(0, '/home/karimy/python3_ws/src')
import click
import numpy as np
import json
...
from abb_python.src import abb_reach
import rospy
...
def train(policy, rollout_worker, evaluator,
    ...
    for epoch in range(n_epochs):
        ...
        for _ in range(n_cycles):
            print("started generating rollouts")
            episode = rollout_worker.generate_rollouts()
            print("episode will start to store")
...
@click.command()
@click.option('--env', type=str, default='ABBReach-v0', help='the name of the OpenAI Gym environment that you want to train on')
